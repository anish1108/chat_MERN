...
function App() {
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center w-screen bg-[#1E272E]">


      <div className="bg-[#242c32] w-[90vw] h-[90vh] p-0 m-0 overflow-auto text-white flex flex-col justify-center items-center rounded-2xl">
